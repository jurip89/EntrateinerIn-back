...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.addColumn('users', 'intro', {type:Sequelize.TEXT});
     await queryInterface.addColumn('jobs','lat',{type:Sequelize.INTEGER,allowNull:false})
     await queryInterface.addColumn('jobs','lng',{type:Sequelize.INTEGER,allowNull:false})
  },
